...
Brand Profile fields: brand_name (Data), brand_code (Data), description (Small Text), logo (Attach Image), logo_dark (Attach Image), primary_color (Color), accent_color (Color), header_bg_color (Color)
