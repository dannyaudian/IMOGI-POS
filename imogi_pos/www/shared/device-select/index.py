...
@require_roles("Cashier", "Waiter", "Kitchen Staff", "Branch Manager", "System Manager")
def get_context(context):
    """Context builder for Select Device page."""
    try:
        # Get branding info
        ...
        frappe.log_error(f"Error in shared_device-select get_context: {str(e)}")
        set_setup_error(context, "generic", str(e), page_name=_("Select Device"))
        context.title = _("Select Device")
        return context
