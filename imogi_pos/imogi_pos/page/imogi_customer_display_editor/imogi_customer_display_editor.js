/**
 * IMOGI Customer Display Editor - Desk to WWW Bridge
 * 
 * PURPOSE:
...
frappe.pages['imogi-customer-display-editor'].on_page_load = function(wrapper) {
	// Immediate redirect to Customer Display Editor WWW route
	window.location.href = '/customer_display_editor';
};
